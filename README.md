...
- [Agent Island](https://agent-island.dev) - Status companion for AI coding agents. Shows live session state for Claude Code, Codex, Gemini, Grok, and Cursor, alerts you when a run is waiting on your turn, and computes quota and cost locally. No account, no telemetry. 🪟 🍎 [🟢](https://github.com/tristan666666/agent-island)
