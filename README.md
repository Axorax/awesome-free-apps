...
- [amtrino](https://github.com/arian-shamaei/amtrino) - Every AI coding session (Claude Code, Codex CLI) as a live identity-colored dot in a menu bar grid; dots pulse while the model responds, flash on finish, and notifications jump to the session's terminal. 🍎 [🟢](https://github.com/arian-shamaei/amtrino)
